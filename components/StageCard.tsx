...
export default function StageCard({currStage, triggerStage, title, children, error, sx} : { currStage: number, triggerStage: number, title: string, children: any, error: any, sx?: any } ){
